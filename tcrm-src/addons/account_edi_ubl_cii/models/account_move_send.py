...
from tcrm import _, api, fields, models, tools, SUPERUSER_ID
from tcrm.addons.account_edi_ubl_cii.models.account_edi_common import SUPPORTED_FILE_TYPES
from tcrm.tools import cleanup_xml_node
from tcrm.tools.pdf import tcrmPdfFileReader, tcrmPdfFileWriter
...
class AccountMoveSend(models.AbstractModel):
    ...
    def _hook_invoice_document_after_pdf_report_render(self, invoice, invoice_data):
        ...
        reader = tcrmPdfFileReader(reader_buffer, strict=False)

        # Post-process.
        writer = tcrmPdfFileWriter()
