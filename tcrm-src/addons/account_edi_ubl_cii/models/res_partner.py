...
from tcrm.addons.account_edi_ubl_cii.models.account_edi_common import EAS_MAPPING
from tcrm.addons.account.models.company import PEPPOL_DEFAULT_COUNTRIES
...
class ResPartner(models.Model):
    ...
    def _get_ubl_cii_formats_info(self):
        return {
            ...
            'ubl_a_nz': {'countries': ['NZ', 'AU'], 'on_peppol': False},  # Not yet available through Tcrm's Access Point, although it's a Peppol valid format
