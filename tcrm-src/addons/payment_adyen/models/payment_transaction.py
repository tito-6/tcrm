...
from tcrm import _, api, models, release
from tcrm.tools import format_amount

from tcrm.addons.payment import utils as payment_utils
from tcrm.addons.payment.logging import get_payment_logger
from tcrm.addons.payment_adyen import const
            ...
            if source_tx:
                ...
                if source_tx.amount == converted_notification_amount:  # Full capture/void.
                    ...
                    if tx and tx.amount != converted_notification_amount:
                        ...
                        # others captures that Tcrm was unaware of were done, the amount voided will
