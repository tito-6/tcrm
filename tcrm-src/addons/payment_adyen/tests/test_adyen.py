...
from tcrm.addons.payment_adyen import utils as adyen_utils
from tcrm.addons.payment_adyen.controllers.main import AdyenController
from tcrm.addons.payment_adyen.tests.common import AdyenCommon
...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with mute_logger('tcrm.addons.payment.models.payment_transaction'), \
            patch(
                'tcrm.addons.payment.utils.generate_access_token',
        ...
        with patch(
            'tcrm.addons.payment.utils.generate_access_token', new=self._generate_test_access_token
        ):
    ...
    @mute_logger('tcrm.addons.payment_adyen.models.payment_transaction')
    ...
    def test_application_info_passed_in_payment_request(self):
        ...
        tx = self._create_transaction('direct')
        with (
            patch('tcrm.addons.payment.utils.check_access_token', return_value='dummy_token'),
            patch(
                'tcrm.addons.payment.models.payment_provider.PaymentProvider._send_api_request',
                return_value=dict(),
    ...
    @mute_logger('tcrm.addons.payment_adyen.controllers.main')
    @mute_logger('tcrm.addons.payment_adyen.models.payment_transaction')
    def _webhook_notification_flow(self, payload):
        ...
        with patch('tcrm.addons.payment_adyen.controllers.main.AdyenController._verify_signature'):
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(AdyenController._webhook_url)
        with patch(
            'tcrm.addons.payment_adyen.controllers.main.AdyenController._verify_signature'
