...
class TestReports(tcrm.tests.HttpCase):
    def test_report_session_cookie(self):
        """ Asserts wkhtmltopdf forwards the user session when requesting resources to Tcrm, such as images,
    ...
    @mute_logger('tcrm.addons.base.models.ir_actions_report')
