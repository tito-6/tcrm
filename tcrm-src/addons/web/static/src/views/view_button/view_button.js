...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(tcrm.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in tcrmToBootstrapClasses) {
                    cls = tcrmToBootstrapClasses[cls];
                }
                classNames.push(cls);
