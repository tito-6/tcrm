...
import { Component, useRef, useSubEnv } from "@tcrm/owl";
 ...
 * It uses a feature to automatically create links to other tcrm pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
