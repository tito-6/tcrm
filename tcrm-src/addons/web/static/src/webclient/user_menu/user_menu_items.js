import { Component, markup } from "@tcrm/owl";
...
export function tcrmAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Tcrm.com Account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.tcrm.com/account", "_blank");
                });
        },
        sequence: 60,
    };
