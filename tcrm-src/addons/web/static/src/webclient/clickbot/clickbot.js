...
import { App, reactive } from "@tcrm/owl";
...
function setup(light, currentState) {
    env = tcrm.__WOWL_DEBUG__.root.env;
    ...
    isEnterprise = tcrm.info && tcrm.info.isEnterprise;
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Tcrm flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
