...
import { Component, onMounted, onWillStart, useExternalListener, useState } from "@tcrm/owl";
...
export class WebClient extends Component {
    ...
    setup() {
        ...
        this.title.setParts({ z_openerp: "TCRM" });
    ...
    registerServiceWorker() {
        if (navigator.serviceWorker) {
            navigator.serviceWorker
                .register("/web/service-worker.js", { scope: "/tcrm" })
                .then((registration) => {
