...
import { Component, onWillStart } from "@tcrm/owl";
...
export class ResConfigDevTool extends Component {
    ...
    setup() {
        this.isDebug = Boolean(tcrm.debug);
        this.isAssets = tcrm.debug.includes("assets");
        this.isTests = tcrm.debug.includes("tests");
