...
import { animationFrame } from "@tcrm/hoot-dom";
import { App } from "@tcrm/owl";
...
/**
 * @typedef {Parameters<typeof import("@tcrm/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@tcrm/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@tcrm/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@tcrm/owl").Component} target
 */
