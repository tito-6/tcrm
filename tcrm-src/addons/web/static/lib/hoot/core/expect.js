 ...
 *
 * @typedef {import("@tcrm/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@tcrm/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@tcrm/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@tcrm/hoot-dom").QueryTextOptions} QueryTextOptions
 * @typedef {import("@tcrm/hoot-dom").Target} Target
 */
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/tcrm/i);
     */
