...
class BasePreferences {
  #defaults = Object.freeze({
    ...
    // Tcrm: don't support scripting (#115302)
    enableScripting: false,
    enableUpdatedAddImage: false,
    // Tcrm: open links in new tabs to keep tcrm document (#84594)
...
class PDFPrintService {
  ...
  layout() {
    ...
    // TCRM PATCH PRINT PREVIEW MOBILE
