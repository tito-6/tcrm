import { getFixture, after } from "@tcrm/hoot";
...
export async function startInteractions(
    ...
    if (tcrm.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = tcrm.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
