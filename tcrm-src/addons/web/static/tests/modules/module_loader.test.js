import { beforeEach, expect, getFixture, test } from "@tcrm/hoot";
import { microTick, tick } from "@tcrm/hoot-dom";
...
/** @type {typeof tcrmModuleLoader} */
const ModuleLoader = Object.getPrototypeOf(tcrm.loader.constructor);
