import { destroy, expect, getFixture, onError, test } from "@tcrm/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@tcrm/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@tcrm/hoot-mock";
import { Component, useRef, useState, xml } from "@tcrm/owl";
import {
    contains,
    getService,
    makeMockEnv,
