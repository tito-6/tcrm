/** @tcrm-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@tcrm/hoot";
import { hover, queryFirst } from "@tcrm/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@tcrm/hoot-mock";
import { Component, onPatched, xml } from "@tcrm/owl";
import {
    contains,
    defineParams,
    mountWithCleanup,
