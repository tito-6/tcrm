import { destroy, expect, test } from "@tcrm/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@tcrm/hoot-dom";
import { animationFrame } from "@tcrm/hoot-mock";
import { Component, onMounted, useState, xml } from "@tcrm/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
