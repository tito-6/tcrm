import { describe, destroy, expect, getFixture, test } from "@tcrm/hoot";
import { click, tick } from "@tcrm/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@tcrm/hoot-mock";
