import { after, destroy, getFixture, queryFirst, queryOne } from "@tcrm/hoot";
 ...
 * @typedef {import("@tcrm/owl").Component} Component
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@tcrm/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
 ...
 * @param {AppConfig & {
 *  componentEnv?: Partial<tcrmEnv>;
 *  containerEnv?: Partial<tcrmEnv>;
