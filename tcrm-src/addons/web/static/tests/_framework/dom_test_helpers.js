...
/**
 * @typedef {import("@tcrm/hoot").DragHelpers} DragHelpers
 * @typedef {import("@tcrm/hoot").DragOptions} DragOptions
 * @typedef {import("@tcrm/hoot").FillOptions} FillOptions
 * @typedef {import("@tcrm/hoot").InputValue} InputValue
 * @typedef {import("@tcrm/hoot").KeyStrokes} KeyStrokes
 * @typedef {import("@tcrm/hoot").PointerOptions} PointerOptions
 * @typedef {import("@tcrm/hoot").Position} Position
 * @typedef {import("@tcrm/hoot").QueryOptions} QueryOptions
 * @typedef {import("@tcrm/hoot").Target} Target
 *
 * @typedef {DragOptions & {
