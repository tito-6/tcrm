...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        tcrm.define = this.define.bind(this);
        tcrm.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@tcrm` (`@tcrm/o-spreadsheet)
     * To ensure that this module is loaded, we have to include `tcrm` in the dependencies
     */
    spreadsheet: ["tcrm"],
    /**
...
const CSRF_TOKEN = tcrm.csrf_token;
...
const R_DEFAULT_MODULE = /^@tcrm\/(owl|hoot)/;
