import { after, afterEach, beforeEach, registerDebugInfo } from "@tcrm/hoot";
 ...
 *
 * @param {Partial<tcrmEnv>} [partialEnv]
 * @param {{
 *  makeNew?: boolean;
 * }} [options]
 */
 ...
 *  (env: tcrmEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
