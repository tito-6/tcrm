/** @tcrm-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@tcrm/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await tcrm.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (tcrm.debug && tcrm.debug.includes("assets")) {
    ...
    QUnit.on("tcrmAfterTestHook", (info) => {
