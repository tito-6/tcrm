...
from tcrm._monkeypatches.stdnum import new_get_soap_client
...
class TestStructure(TransactionCase):
    ...
    def test_parent_validation(self):
        ...
        with patch('tcrm.addons.base_vat.models.res_partner.check_vies', type(self)._vies_check_func):
    ...
    def test_no_vies_revalidation_when_creating_company_from_contact(self):
        ...
        with patch('tcrm.addons.base_vat.models.res_partner.check_vies',
