...
from tcrm import _, api, exceptions, fields, models
from tcrm.exceptions import LockError, MissingError
from tcrm.fields import Domain
from tcrm.http import request
from tcrm.tools import safe_eval
...
def _get_domain_fields(env, model, domain):
    ...
    # see: https://github.com/tcrm/tcrm/pull/189772#issuecomment-2548804283
