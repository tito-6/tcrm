...
from tcrm import api, fields, models, modules, tools
from tcrm.addons.iap.tools import iap_tools
from tcrm.addons.mail.tools import mail_validation
from tcrm.addons.phone_validation.tools import phone_validation
from tcrm.exceptions import UserError, AccessError, ValidationError
from tcrm.fields import Domain
from tcrm.tools.translate import _
from tcrm.tools import date_utils, email_normalize_all, is_html_empty, groupby, parse_contact_from_email, SQL
