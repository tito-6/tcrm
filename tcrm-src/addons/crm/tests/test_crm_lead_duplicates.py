...
from tcrm.addons.crm.tests.common import TestCrmCommon
from tcrm.addons.iap.tools import iap_tools
from tcrm.tests.common import tagged, users
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@tcrm.com', 'fp@tcrm.com'),
            ('fp.alias@mail.tcrm.com', 'fp.alias@mail.tcrm.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.tcrm.com', 'subdomain.tcrm.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@TCRM.COM>',
                'name': 'Dupe1 of fp@tcrm.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@tcrm.com',
                'name': 'Dupe2 of fp@tcrm.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.tcrm.com',
                'name': 'Dupe3 of fp@tcrm.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                'email_from': 'not.fp@not.tcrm.com',
                'phone': '+1 202 555 0123',
                'name': 'Dupe4 of fp@tcrm.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@tcrm.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@tcrm.com (same commercial entity)',
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@tcrm.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@tcrm.com')
