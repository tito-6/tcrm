...
from tcrm.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('tcrm.models.unlink', 'tcrm.addons.crm.models.crm_team', 'tcrm.addons.crm.models.crm_team_member')
