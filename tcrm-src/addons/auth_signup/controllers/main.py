...
from tcrm import http, tools, _
from tcrm.addons.auth_signup.models.res_users import SignupError
from tcrm.addons.web.controllers.home import ensure_db, Home, SIGN_UP_REQUEST_PARAMS, LOGIN_SUCCESSFUL_PARAMS
from tcrm.addons.web.models.res_users import SKIP_CAPTCHA_LOGIN
from tcrm.addons.base_setup.controllers.main import BaseSetup
