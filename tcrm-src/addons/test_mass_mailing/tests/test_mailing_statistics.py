...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('tcrm.addons.mass_mailing.models.mailing', 'tcrm.addons.mail.models.mail_mail', 'tcrm.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.tcrm.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.tcrm.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.tcrm.be')
