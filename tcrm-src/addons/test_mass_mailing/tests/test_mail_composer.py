...
from tcrm.tests import freeze_time, tagged, users
from tcrm.tools import mute_logger

from tcrm.addons.test_mail.tests.test_mail_composer import TestMailComposer
...
class TestMailComposerMassMailing(TestMailComposer, common.TestMassMailCommon):
    ...
    @mute_logger('tcrm.addons.mass_mailing.models.mailing')
