...
from tcrm.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from tcrm.addons.l10n_account_edi_ubl_cii_tests.tests.common import TestUBLCommon
...
class TestUBLDKOIOUBL21(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def create_post_and_send_invoice(self, partner=None, move_type='out_invoice'):
        ...
        invoice.action_post()
        with patch('tcrm.addons.l10n_dk_nemhandel.models.res_partner.ResPartner._get_nemhandel_verification_state', return_value='not_valid'):
    ...
    def test_export_invoice_partner_dk(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_tcrm/oioubl_out_invoice_partner_dk.xml")
    ...
    def test_export_invoice_foreign_partner_be(self):
        ...
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_tcrm/oioubl_out_invoice_foreign_partner_be.xml")

    @freeze_time('2017-01-01')
    def test_export_invoice_foreign_partner_fr(self):
        invoice = self.create_post_and_send_invoice(partner=self.partner_c)
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_tcrm/oioubl_out_invoice_foreign_partner_fr.xml")
    ...
    def test_export_credit_note_partner_dk(self):
        ...
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_tcrm/oioubl_out_refund_partner_dk.xml")
    ...
    def test_export_credit_note_partner_fr(self):
        ...
        self.assertTrue(refund.ubl_cii_xml_id)
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_tcrm/oioubl_out_refund_foreign_partner_fr.xml")
    ...
    def test_oioubl_export_import_with_discount(self):
        ...
        invoice.action_post()
        with patch('tcrm.addons.l10n_dk_nemhandel.models.res_partner.ResPartner._get_nemhandel_verification_state',
            ...
            wizard.action_send_and_print()
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_tcrm/oioubl_out_invoice_discount.xml")
