...
from tcrm.tests import Form, users
from tcrm.tools.misc import format_date
from tcrm.tests.common import HttpCase, tagged
...
class TestTourMrpOrder(HttpCase):
    def test_mrp_order_product_catalog(self):
        ...
        url = f'/tcrm/action-mrp.mrp_production_action/{mo.id}'
    ...
    def test_manufacturing_and_byproduct_sm_to_sml_synchronization(self):
        ...
        url = f'/tcrm/action-{action_id.id}/{mo.id}'
