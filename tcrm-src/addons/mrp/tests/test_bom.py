...
from tcrm import exceptions, fields
from tcrm.fields import Command
from tcrm.tests import Form, HttpCase, freeze_time, tagged
from tcrm.tools import float_compare, float_repr, float_round
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see tcrm/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/tcrm/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/tcrm/action-mrp.mrp_bom_form_action'
