...
/**
 *
 * @typedef {import("@spreadsheet").tcrmPivotDefinition} tcrmPivotDefinition
...
export class PivotCoreGlobalFilterPlugin extends tcrmCorePlugin {
    ...
    export(data) {
        for (const id in this.pivots) {
            ...
            data.pivots[id].fieldMatching =
                pivot.type === "TCRM" ? this.pivots[id].fieldMatching : {};
        }
    }
}
