...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@tcrm/o-spreadsheet";
...
/**
 * @typedef {import("@tcrm/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@tcrm/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class tcrmPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").tcrmEnv} env
     * @param {import("@spreadsheet").tcrmPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").tcrmGetters}
         */
    ...
    /**
     * Get the Tcrm domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@tcrm/o-spreadsheet").PivotDimension} dimension
