...
import { registries, helpers, constants, EvaluationError } from "@tcrm/o-spreadsheet";
...
function boundedtcrmNumberDateAdapter(lower, upper) {
    return {
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(tcrmWeekAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(tcrmQuarterAdapter));

extendSpreadsheetAdapter("day", tcrmDayAdapter);
extendSpreadsheetAdapter("year", tcrmYearAdapter);
extendSpreadsheetAdapter("day_of_month", boundedtcrmNumberDateAdapter(1, 31));
extendSpreadsheetAdapter("iso_week_number", boundedtcrmNumberDateAdapter(0, 54));
extendSpreadsheetAdapter("month_number", boundedtcrmNumberDateAdapter(1, 12));
extendSpreadsheetAdapter("quarter_number", boundedtcrmNumberDateAdapter(1, 4));
extendSpreadsheetAdapter("day_of_week", tcrmDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", tcrmHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", tcrmMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", tcrmSecondNumberAdapter);
extendSpreadsheetAdapter("month", tcrmMonthAdapter);
