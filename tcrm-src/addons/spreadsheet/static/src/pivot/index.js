...
import { PivottcrmCorePlugin } from "./plugins/pivot_tcrm_core_plugin";
...
coreTypes.add("UPDATE_tcrm_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_tcrm_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_tcrm_PIVOT_DOMAIN", identity);

export { PivottcrmCorePlugin, PivotCoreViewGlobalFilterPlugin, PivotUIGlobalFilterPlugin };
