...
import { astToFormula, helpers } from "@tcrm/o-spreadsheet";
...
/**
 * @param {import("@tcrm/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@tcrm/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").tcrmGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "TCRM.LIST"
    );
};
