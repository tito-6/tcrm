...
export class ListUIPlugin extends tcrmUIPlugin {
    ...
    handle(cmd) {
        switch (cmd.type) {
            case "INSERT_tcrm_LIST_WITH_TABLE": {
                this.dispatch("INSERT_tcrm_LIST", cmd);
                this._addTable(cmd);
                break;
            }
            case "RE_INSERT_tcrm_LIST_WITH_TABLE": {
                this.dispatch("RE_INSERT_tcrm_LIST", cmd);
                this._addTable(cmd);
                break;
            }
        }
