...
class BadtcrmLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadtcrmLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .replace("tcrmMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadtcrmLinkError(menuId);
                    }
                    return {
                        url,
                        label,
