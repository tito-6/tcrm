...
/**
 * @typedef {Object} tcrmModelMetaData
 * @property {string} resModel
 * @property {tcrmFields} [fields]
 *
 * @typedef {Object} tcrmModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class tcrmViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {tcrmModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {tcrmModelMetaData} */
    ...
    /**
     * @returns {tcrmFields} List of fields
     */
    getFields() {
     ...
     * @returns {tcrmField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
