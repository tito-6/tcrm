...
import { CellErrorType, EvaluationError } from "@tcrm/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./tcrm_data_provider").tcrmDataProvider} tcrmDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {tcrmDataProvider} param0.tcrmDataProvider
     */
    constructor({ tcrmDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.tcrmDataProvider.orm;
    }

    get serverData() {
        return this.tcrmDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.tcrmDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.tcrmDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").tcrmFields>}
 */
