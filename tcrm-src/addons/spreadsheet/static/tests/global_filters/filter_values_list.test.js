...
import { click, edit, queryAllTexts } from "@tcrm/hoot-dom";
...
import { Component, onWillUnmount, xml } from "@tcrm/owl";
...
test("basic text filter", async function () {
    ...
    const model = new Model({}, { custom: { tcrmDataProvider: new tcrmDataProvider(env) } });
