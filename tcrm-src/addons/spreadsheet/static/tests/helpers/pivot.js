...
import { tcrmPivot } from "@spreadsheet/pivot/tcrm_pivot";
...
async function insertStaticPivot(model, pivotId, params) {
    ...
    if (!(ds instanceof tcrmPivot)) {
        throw new Error("The pivot data source is not an tcrmPivot");
    }
 ...
 * @returns {Promise<{ model: tcrmSpreadsheetModel, env: object, pivotId: string}>}
 */
