...
from tcrm.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'tcrm.addons.payment_mollie.controllers.main',
        'tcrm.addons.payment_mollie.models.payment_transaction',
    )
