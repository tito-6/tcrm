...
from tcrm import _, fields, models, service
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(self, *args, **kwargs):
        ...
        tcrm_version = service.common.exp_version()['server_version']
        ...
        return {
            ...
            'User-Agent': f'Tcrm/{tcrm_version} MollieNativetcrm/{module_version}',
        }
