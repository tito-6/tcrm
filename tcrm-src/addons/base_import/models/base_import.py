...
class Base_ImportMapping(models.Model):
    ...
    not match Tcrm's field names or labels. This model is used
    ...
    def get_fields_tree(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: name: str
                ...
                The field's logical (Tcrm) name within the scope of
                its parent.
            ...
            .. attribute:: model_name: str
                ...
                Used in the Tcrm Field Tooltip on the import view
