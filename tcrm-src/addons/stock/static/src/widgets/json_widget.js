...
import { Component, onWillStart, useEffect, useRef } from "@tcrm/owl";
...
export class ReplenishmentGraphWidget extends JsonPopOver {
    ...
    getScatterGraphConfig() {
        ...
        const maxLineColor = getColor(1, cookie.get("color_scheme"), "tcrm");
        const minLineColor = getColor(2, cookie.get("color_scheme"), "tcrm");
        const curveLineColor = getColor(3, cookie.get("color_scheme"), "tcrm");
        return {
            type: "scatter",
            data: {
                labels,
