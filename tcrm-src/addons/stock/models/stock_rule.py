...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~tcrm.addons.product.models.product.ProductProduct`
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type procurements: list of `~tcrm.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
