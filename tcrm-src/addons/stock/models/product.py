...
from tcrm.tools.barcode import check_barcode_encoding
from tcrm.tools.float_utils import float_compare
from tcrm.tools.mail import html2plaintext, is_html_empty
...
class ProductTemplate(models.Model):
    ...
    def _default_responsible_id(self):
        # Return the current user unless it's tcrmBot
