...
from tcrm import _, api, Command, fields, models, SUPERUSER_ID
...
from tcrm.tools.misc import clean_context, OrderedSet, groupby
...
Please change the quantity done or the rounding precision in your settings.""",
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=tcrmbot_id, subject=msg_subject)
