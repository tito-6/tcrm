...
from tcrm.addons.payment_authorize.tests.common import AuthorizeCommon
...
class AuthorizeTest(AuthorizeCommon):
    ...
    def test_amount_validation_is_skipped_when_transaction_details_are_missing(self):
        ...
        with patch(
            'tcrm.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
    ...
    @mute_logger('tcrm.addons.payment_authorize.models.payment_transaction')
