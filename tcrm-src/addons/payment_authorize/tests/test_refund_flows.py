...
class TestRefundFlows(AuthorizeCommon):
    ...
    def test_refunding_authorized_tx_voids_it(self):
        ...
        with patch(
            ...
            'tcrm.addons.payment_authorize.models.authorize_request.AuthorizeAPI.void'
        ) as void_mock, patch(
    ...
    def test_refunding_captured_tx_refunds_it_and_creates_refund_tx(self):
        ...
        create a refund transaction on Tcrm. """
        source_tx = self._create_transaction('direct', state='done')
        with patch(
            'tcrm.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
            '.get_transaction_details',
            ...
            'tcrm.addons.payment_authorize.models.authorize_request.AuthorizeAPI.refund'
