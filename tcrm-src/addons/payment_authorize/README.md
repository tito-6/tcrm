...
- `16.1`
  - The "Authorize Currency" field is replaced by the generic "Currencies" field of `payment`.
    tcrm/tcrm#101018
- `16.0`
  - Archiving a token no longer deactivates the related payment method on Authorize. tcrm/tcrm#93774
- `15.4`
  - The support for full refunds is added. tcrm/tcrm#92279
- `15.0`
  - Support for ACH payments is added. tcrm/tcrm#75289
- `14.3`
