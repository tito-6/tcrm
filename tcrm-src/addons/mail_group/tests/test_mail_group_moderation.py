...
from tcrm.addons.mail_group.tests.data import GROUP_TEMPLATE
from tcrm.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('tcrm.models.unlink', 'tcrm.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('tcrm.addons.base.models.ir_rule', 'tcrm.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('tcrm.addons.mail.models.mail_thread', 'tcrm.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('tcrm.addons.mail.models.mail_thread', 'tcrm.addons.mail_group.models.mail_group_message', 'tcrm.models.unlink')
    @users('employee')
    ...
    @mute_logger('tcrm.addons.mail_group.models.mail_group')
    @users('employee')
