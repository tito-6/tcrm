...
from tcrm.tools import float_compare, float_round
from tcrm.addons.l10n_jo_edi.tests.jo_edi_common import JoEdiCommon
from tcrm.addons.l10n_jo_edi.models.account_edi_xml_ubl_21_jo import JO_MAX_DP
...
class TestJoEdiPrecision(JoEdiCommon):
    ...
    def _validate_jo_edi_numbers(self, xml_string, invoice):
        ...
        Moreover, reported totals have to equal (or at least be as close as possible) to totals stored in Tcrm.
        And since the JOD has precision of 3 decimal places, everything is stored in Tcrm approximated to 3 decimal places.
        -------------------------------------------------------------------------------
