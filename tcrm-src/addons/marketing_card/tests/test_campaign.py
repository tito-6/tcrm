...
from tcrm.tests import Form, HttpCase, tagged, warmup
from tcrm.addons.mail.tests.common import MailCase
from tcrm.addons.marketing_card.controllers.marketing_card import SOCIAL_NETWORK_USER_AGENTS
...
class TestMarketingCardRender(MarketingCardCommon):
    ...
    def test_campaign(self):
        ...
        with patch('tcrm.addons.marketing_card.models.card_campaign.CardCampaign._get_model_selection',
    ...
    def test_fetch_datetime(self):
        ...
        for tz in timezones:
            ...
            with patch(
                    'tcrm.addons.mail.models.models.Base._mail_get_timezone',
                    lambda model: tz
            ):
