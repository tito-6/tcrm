import { Component, EventBus, onWillDestroy, onWillStart, useState } from "@tcrm/owl";
    ...
    start(env, { bus_service, dialog, presence }) {
        ...
        const checkIdentityErrorHandler = (env, error, originalError) => {
            if (originalError instanceof RPCError) {
                if (originalError.data.name === "tcrm.addons.auth_timeout.models.ir_http.CheckIdentityException") {
                    run();
                    return true;
                }
            }
