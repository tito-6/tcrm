...

{
    ...
    'website': 'https://www.tcrm.com/app/website',
    'version': '1.0',
    'depends': [
        'digest',
        'web',
    ...
    'data': [
        ...
        'views/snippets/s_mega_menu_tcrm_menu.xml',
    ...
    'assets': {
        ...
        'web.assets_frontend': [
            ...
            'website/static/src/libs/zoomtcrm/zoomtcrm.scss',
            'website/static/src/scss/website.scss',
            'website/static/src/scss/website_common.scss',
            'website/static/src/scss/website_controller_page.scss',
            'website/static/src/scss/website.ui.scss',
            'website/static/src/libs/zoomtcrm/zoomtcrm.js',
