...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        ...addNewSocialNetwork(10, 9, "https://instagr.am/tcrm.official/"),
        {
            ...
            trigger:
                ...
                ":has(a:eq(9)[href='https://instagr.am/tcrm.official/']:has(i.fa-instagram))",
        },
        ...
        },
        {
            ...
            run: "edit https://instagram.com/tcrm.official/ && click body",
        },
        ...preventRaceConditionStep,
        ...clickOnSave(),
        ...clickOnEditAndWaitEditMode(),
