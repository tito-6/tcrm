...
import { App, Component } from "@tcrm/owl";
...
export function sendRequest(route, params) {
    ...
    if (tcrm.csrf_token) {
        _addInput(form, "csrf_token", tcrm.csrf_token);
    }
...
patch(urlUtils, {
    isAbsoluteURLInCurrentDomain(url, env = null) {
        ...
        // Make sure that while being on abc.tcrm.com, if you edit a link and
        // enter an absolute URL using your real domain, it is still considered
        // to be added as relative, preferably.
        // In the past, you could not edit your website from abc.tcrm.com if you
