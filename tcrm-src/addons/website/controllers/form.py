...
from tcrm import http, SUPERUSER_ID
from tcrm.addons.base.models.ir_qweb_fields import nl2br, nl2br_enclose
from tcrm.http import request
from tcrm.tools import plaintext2html
from tcrm.exceptions import AccessDenied, ValidationError, UserError
from tcrm.tools.misc import hmac, consteq
