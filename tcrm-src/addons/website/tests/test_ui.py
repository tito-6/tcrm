...
from tcrm.addons.html_editor.controllers.main import HTML_Editor
from tcrm.addons.website.tests.common import HttpCaseWithWebsiteUser
from tcrm.fields import Command


@tcrm.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(tcrm.tests.HttpCase):
...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/tcrm/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@tcrm.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@tcrm.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(tcrm.tests.HttpCase):
...
class TestUi(HttpCaseWithWebsiteUser):
    ...
    def test_01_admin_tour_homepage(self):
        self.start_tour("/tcrm", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/tcrm', 'conditional_visibility_2', login='website_user')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/tcrm", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/tcrm', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/tcrm', 'website_gray_color_palette', login='admin')
    ...
    def test_26_website_media_dialog_icons(self):
        self.env.ref('website.default_website').write({
            'social_twitter': 'https://twitter.com/Tcrm',
            'social_facebook': 'https://www.facebook.com/Tcrm',
            'social_linkedin': 'https://www.linkedin.com/company/tcrm',
            'social_youtube': 'https://www.youtube.com/user/OpenERPonline',
            'social_github': 'https://github.com/tcrm',
            'social_instagram': 'https://www.instagram.com/explore/tags/tcrm/',
            'social_tiktok': 'https://www.tiktok.com/@tcrm',
    ...
    def test_27_website_clicks(self):
        self.start_tour('/tcrm', 'website_click_tour', login='admin')
    ...
    def test_33_website_menus(self):
        ...
        self.start_tour("/tcrm/action-website.action_website_menu", "parent_child_menu", login="admin")
