...
import logging
from tcrm import api, fields, models, modules
from tcrm.tools.translate import xml_translate
from tcrm.modules.module import get_resource_from_path

from tcrm.addons.base.models.ir_asset import AFTER_DIRECTIVE, APPEND_DIRECTIVE, BEFORE_DIRECTIVE, DEFAULT_SEQUENCE, INCLUDE_DIRECTIVE, PREPEND_DIRECTIVE, REMOVE_DIRECTIVE, REPLACE_DIRECTIVE
