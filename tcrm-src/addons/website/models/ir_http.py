...
import tcrm
from tcrm import api, models, tools
...
from tcrm.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from tcrm.addons.website.models import ir_http
...
class IrHttp(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(tcrm.tools.config['server_wide_modules'])
