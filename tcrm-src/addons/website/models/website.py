...
from tcrm import api, fields, models, tools, release
from tcrm.addons.website.models.ir_http import sitemap_qs2dom
from tcrm.addons.website.tools import similarity_score, text_from_html, get_base_domain
from tcrm.addons.portal.controllers.portal import pager
from tcrm.addons.iap.tools import iap_tools
...
from tcrm.modules.module import get_manifest
from tcrm.tools import SQL, Query
from tcrm.tools.image import image_process
from tcrm.tools.sql import escape_psql
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.tcrm.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.tcrm.com'
...
class Website(models.Model):
        ...
        for model_name, field_name in self._get_html_fields():
            ...
            if dependency_records:
                ...
                dependencies[model_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/tcrm/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        ...
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Tcrm framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False, mode_debug=0):
        ...
        return "/tcrm/action-website.website_preview?" + urls.url_encode(action_params)
