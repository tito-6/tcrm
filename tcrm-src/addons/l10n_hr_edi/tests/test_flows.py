...
from tcrm.addons.account.tests.common import PatchRequestsMixin
from tcrm.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from tcrm.addons.l10n_hr_edi.tests.test_hr_edi_common import TestL10nHrEdiCommon
...
class TestHrEdiFlowsMocked(TestL10nHrEdiCommon, TestAccountMoveSendCommon, PatchRequestsMixin):
    ...
    def setUpClass(cls):
        ...
        company.write({
            ...
            'l10n_hr_mer_software_ident': 'Satcrm-001',
            ...
            (
                ...
                self._build_response(
                    ...
                    response_json={
                        ...
                        'RecipientBusinessName': 'Tcrm S.A.',
