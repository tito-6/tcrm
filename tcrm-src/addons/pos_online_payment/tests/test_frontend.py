...
from tcrm.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
from tcrm.addons.mail.tests.common import mail_new_test_user
from tcrm.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from tcrm.addons.account.models.account_payment_method import AccountPaymentMethod
from tcrm.addons.point_of_sale.tests.common import archive_products
...
class TestUi(TestPointOfSaleHttpCommon, OnlinePaymentCommon):
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('tcrm.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
