...
from tcrm import fields, tests
from tcrm.addons.mail.models.mail_activity import MailActivity
from tcrm.addons.mail.tests.common import mail_new_test_user
from tcrm.addons.test_mail.tests.test_mail_activity import TestActivityCommon
