...
from tcrm.addons.test_mail.models.test_mail_corner_case_models import MailTestMultiCompanyWithActivity
from tcrm.addons.test_mail.tests.common import TestRecipients
from tcrm.exceptions import AccessError
from tcrm.tests import tagged, users, HttpCase
...
class TestMultiCompanySetup(TestMailMCCommon, HttpCase):
    ...
    @users('employee_c2')
    @mute_logger('tcrm.addons.base.models.ir_rule')
            ...
            with self.subTest(login=login, mc_record=mc_record):
                ...
                if not login:
                    ...
                    if mc_error:
                        ...
                        self.assertEqual(parsed_url.path, '/tcrm/action-mail.action_discuss')
                    else:
