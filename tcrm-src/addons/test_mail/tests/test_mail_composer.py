...
from tcrm.addons.mail.wizard.mail_compose_message import MailComposeMessage
...
from tcrm.fields import Datetime as FieldDatetime
from tcrm.exceptions import AccessError, UserError
from tcrm.tests import Form, tagged, users
from tcrm.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('tcrm.tests', 'tcrm.addons.mail.models.mail_mail', 'tcrm.models.unlink')
    ...
    @mute_logger('tcrm.tests', 'tcrm.addons.base.models.ir_rule', 'tcrm.addons.mail.models.mail_mail', 'tcrm.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('tcrm.models.unlink', 'tcrm.addons.mail.models.mail_mail', 'tcrm.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('tcrm.models.unlink', 'tcrm.addons.mail.models.mail_mail')
