...
from tcrm.addons.sms.models.mail_thread import MailThread
from tcrm.addons.sms.tests.common import SMSCommon, SMSCase
...
class TestSMSComposerComment(SMSCommon, SMSCase):
    ...
    def test_message_post_sms_vs_notification(self):
        ...
        cases = [
            (
                'Hello there, check this awesome <b>app</b> I found:<br/>https://tcrm.com',  # not a `a` link in source
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;<a href="https://tcrm.com" target="_blank" rel="noreferrer noopener">https://tcrm.com</a></p>',
                'Hello there, check this awesome <b>app</b> I found:<br/>https://tcrm.com'
            ), (
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://tcrm.com">Here</a>',   # a link
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;&lt;a href="<a href="https://tcrm.com" target="_blank" rel="noreferrer noopener">https://tcrm.com</a>"&gt;Here&lt;/a&gt;</p>',
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://tcrm.com">Here</a>'  # keep all information
            )
        ]
    ...
    def test_message_sms_body_sms_vs_notification(self):
        ...
        cases = [
            (
                ...
                '<a href="https://tcrm.com" target="_blank" rel="noreferrer noopener">https://tcrm.com</a></p>',
            ), (
