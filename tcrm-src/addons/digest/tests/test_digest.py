...
class TestUnsubscribe(MailCommon, HttpCaseWithUserDemo):
    ...
    def test_unsubscribe_token_one_click(self):
        ...
        with mute_logger('tcrm.addons.http_routing.models.ir_http'):
