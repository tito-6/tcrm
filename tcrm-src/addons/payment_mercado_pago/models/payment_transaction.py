...
class PaymentTransaction(models.Model):
    ...
    def _apply_updates(self, payment_data):
        ...
        for tcrm_code, mp_codes in const.PAYMENT_METHODS_MAPPING.items():
            if any(payment_method_type == mp_code for mp_code in mp_codes.split(',')):
                payment_method_type = tcrm_code
                break
        ...
        # the user might have picked a different payment method than on Tcrm's payment form.
