...
from tcrm.exceptions import RedirectWarning, ValidationError
...
from tcrm.addons.payment.const import REPORT_REASONS_MAPPING
...
class PaymentProvider(models.Model):
    ...
    def _compute_mercado_pago_is_oauth_supported(self):
        """Return current state of OAuth support by Tcrm. To be removed in future versions."""
