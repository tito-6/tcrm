...
- `19.0`
  - OAuth support is added in addition to the credentials-based authentication. tcrm/tcrm#194998
  - Support for tokenization is added. tcrm/tcrm#194998
- `16.0`
  - The first version of the module is merged. tcrm/tcrm#83957
