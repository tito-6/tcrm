...
from tcrm.addons.mail.tests.common import MockEmail
...
class TestCloudStorageAzure(TestCloudStorageAzureCommon, MockEmail):
    def test_get_user_delegation_key_success(self):
        ...
        with patch('tcrm.addons.cloud_storage_azure.utils.cloud_storage_azure_utils.requests.post', post):
    ...
    def test_generate_sas_url(self):
        with patch('tcrm.addons.cloud_storage_azure.models.ir_attachment.get_cloud_storage_azure_user_delegation_key', return_value=self.DUMMY_USER_DELEGATION_KEY):
    ...
    def test_azure_url_validation(self):
        ...
        def mk_url(account_name='admin', container_name='tcrm-container'):
