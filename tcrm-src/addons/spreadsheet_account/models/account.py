...
from tcrm import models, api, _
from tcrm.fields import Domain
from tcrm.tools import date_utils
...
class AccountAccount(models.Model):
    ...
    def spreadsheet_fetch_debit_credit(self, args_list):
        """Fetch data for TCRM.CREDIT, TCRM.DEBIT and TCRM.BALANCE formulas
    ...
    def spreadsheet_fetch_residual_amount(self, args_list):
        """Fetch data for TCRM.RESUDUAL formulas
        The input list looks like this::
    ...
    def spreadsheet_fetch_partner_balance(self, args_list):
        """Fetch data for TCRM.PARTNER.BALANCE formulas
        The input list looks like this::
    ...
    def spreadsheet_fetch_balance_tag(self, args_list):
        """Fetch data for TCRM.BALANCE.TAG formulas
        The input list looks like this::
