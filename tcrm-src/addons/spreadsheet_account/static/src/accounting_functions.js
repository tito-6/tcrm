...
import { EvaluationError } from "@tcrm/o-spreadsheet";
...
const tcrm_PARTNER_BALANCE_ARGS = () => {
    const partner_arg = arg("partner_ids (string)", _t("The partner ids (separated by a comma)."));
    return [partner_arg, ...tcrm_RESIDUAL_ARGS()];
}

functionRegistry.add("TCRM.CREDIT", {
...
functionRegistry.add("TCRM.DEBIT", {
...
functionRegistry.add("TCRM.BALANCE", {
...
functionRegistry.add("TCRM.FISCALYEAR.START", {
...
functionRegistry.add("TCRM.FISCALYEAR.END", {
...
functionRegistry.add("TCRM.ACCOUNT.GROUP", {
...
functionRegistry.add("TCRM.BALANCE.TAG", {
