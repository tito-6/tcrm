...
import tcrm
from tcrm import http, models
from tcrm.api import Self
from tcrm.exceptions import AccessError
from tcrm.http import request
from tcrm.modules.module_graph import ModuleGraph
from tcrm.service.model import get_public_method
from tcrm.tools import hmac, json_default, lazy_classproperty, py_to_js_locale
...
class DocController(http.Controller):
    ...
    def doc_index(self):
        ...
        # installed.
        # TODO: gzip
        filename = f'tcrm-doc-index-{db_registry_sequence}-{unique}.json'
...
DOC_API_MAGIC_COLUMNS = list(tcrm.models.MAGIC_COLUMNS)
...
# works much better than tcrm.tools.lazy.
class _DocUtils:
