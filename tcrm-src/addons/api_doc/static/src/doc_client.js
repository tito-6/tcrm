import { Component, useState, onMounted, useSubEnv } from "@tcrm/owl";
...
export class DocClient extends Component {
    ...
    setup() {
        this.setTheme(localStorage.getItem("theme") || "tcrm-dark");
    ...
    toggleTheme() {
        this.setTheme(this.theme === "tcrm-dark" ? "tcrm-light" : "tcrm-dark");
    }
