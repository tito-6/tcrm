...
from tcrm import api, fields, models, _, service
from tcrm.tools import file_open, split_every
...
class PosConfig(models.Model):
    ...
    def _compute_selection_pay_after(self):
        ...
        if version_info[-1] == '':
            selection_each_label = f"{selection_each_label} {_('(require Tcrm Enterprise)')}"
    ...
    def get_pos_qr_order_data(self):
        ...
        url_form = "https://www.tcrm.com/app/point-of-sale-restaurant-qr-code"
