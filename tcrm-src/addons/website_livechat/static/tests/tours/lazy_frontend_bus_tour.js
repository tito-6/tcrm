...
registry.category("web_tour.tours").add("website_livechat.lazy_frontend_bus", {
    url: "/",
    steps: () => {
        const busService = tcrm.__WOWL_DEBUG__.root.env.services.bus_service;
        ...
        const workerService = tcrm.__WOWL_DEBUG__.root.env.services.worker_service;
        ...
        tcrm.__WOWL_DEBUG__.root.env.services["mail.store"].isReady.then(() =>
