...
from tcrm import _, api, fields, models, tools, Command
from tcrm.addons.base.models.avatar_mixin import get_hsl_from_seed
from tcrm.addons.base.models.ir_mail_server import MailDeliveryException
from tcrm.addons.mail.tools.discuss import Store
from tcrm.addons.mail.tools.web_push import PUSH_NOTIFICATION_TYPE
from tcrm.exceptions import AccessError, UserError, ValidationError
from tcrm.fields import Domain
from tcrm.tools import format_list, email_normalize, html_escape
from tcrm.tools.misc import hash_sign, OrderedSet
from tcrm.tools.sql import SQL
...
class DiscussChannel(models.Model):
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        return {
            "type": "ir.actions.act_url",
            "url": f"/tcrm/action-mail.action_discuss?active_id={self.id}",
            "target": "self",
        }
