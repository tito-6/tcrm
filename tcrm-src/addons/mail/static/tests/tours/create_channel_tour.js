...
registry.category("web_tour.tours").add("can_create_channel_from_form_view", {
    steps: () => [
        {
            trigger: ".o-mail-DiscussSidebarChannel-itemName:contains(tcrmBot)",
            run: "click",
        },
        {
            trigger: ".o-mail-DiscussContent-threadName[title='tcrmBot']",
        },
        ...
        {
            trigger: ".breadcrumb-item:contains('tcrmBot')",
            run: "click",
        },
        {
