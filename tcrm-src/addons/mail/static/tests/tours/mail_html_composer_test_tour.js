    ...
    steps: () => [
        {
            ...
            async run() {
                const composerService = tcrm.__WOWL_DEBUG__.root.env.services["mail.composer"];
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.tcrm-editor-editable",
            run: "editor Hello",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.tcrm-editor-editable strong:contains(Hello)",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_mail_composer_message .tcrm-editor-editable",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.tcrm-editor-editable em:contains(Hello)",
        },
    ],
});
