...
import { after, before, beforeEach, expect, test } from "@tcrm/hoot";
import { press, queryOne } from "@tcrm/hoot-dom";
import { animationFrame, enableTransitions } from "@tcrm/hoot-mock";
import {
    clickSave,
    contains,
    defineModels,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".tcrm-editor-editable").toHaveInnerHTML("<h1> first </h1>");
