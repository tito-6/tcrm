/** @tcrm-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@tcrm/hoot";
import { queryAll, queryFirst } from "@tcrm/hoot-dom";
 ...
 *
 * @param {import("@tcrm/hoot-dom").Target} selector
 ...
 *  element.
 * @property {HTMLElement|tcrmEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when tcrmEnv, special key `target`. See @start
