...
from tcrm.addons.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/tcrm", 0),
                ("http://localhost:8069/", "http://localhost:8069/tcrm/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/tcrm-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.tcrm.com/", "https://www.tcrm.com/web", 0),
                ("https://www.tcrm.com/", "https://www.tcrm.com/tcrm", 0),
                ("https://www.tcrm.com/", "https://www.tcrm.com/tcrm/", 0),
                ("https://www.tcrm.com/", "https://www.tcrm.com/tcrm?debug=assets", 0),
                ("https://www.tcrm.com/", "https://www.tcrm.com/tcrm#anchor", 0),
                ("https://www.tcrm.com/", "https://www.tcrm.com/tcrm-experience", 1),
                ("https://www.tcrm.com/", "https://www.tcrm.com/tcrm/1519/tasks/4102866", 0),
                ("http://www.tcrm.com/", "https://www.tcrm.com/tcrm/1519/tasks/4102866", 1),
                ("https://www.tcrm.com/", "https://wwwatcrm.com/tcrm/", 1),
                ("https://www.tcrm.com/", "https://www.tcrm.com/chat/", 0),
                ("https://www.tcrm.com/", "https://www.tcrm.com/chat/5/bFtIfYHRco", 0),
                ("http://www.tcrm.com/", "https://www.tcrm.com/chat/5/bFtIfYHRco", 1),
                ("https://clients.tcrm.com/", "https://www.tcrm.com/tcrm/1519/tasks/4102866", 1),
                ("https://clients.tcrm.com/", "https://www.tcrm.com/chat/5/bFtIfYHRco", 1),
            ]
    ...
    def test_remove_unused_link_preview(self):
        with (
            ...
            message = self.test_partner.message_post(
                body=Markup(
                    '<a href="https://www.tcrm.com/tcrm-experience">Nothing link</a> <a href="https://www.tcrm.com/tcrm-experience-2025">Other Nothing link</a>'
                ),
            ...
            self.test_partner._message_update_content(
                message,
                body=Markup('<a href="https://www.tcrm.com/tcrm-experience">Nothing link</a>'),
            )
            self.env["mail.link.preview"]._create_from_message_and_notify(message)
            link_preview_count = self.env["mail.message.link.preview"].search_count(
                [("message_id", "=", message.id)]
