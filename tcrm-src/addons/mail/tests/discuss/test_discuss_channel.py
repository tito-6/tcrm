...
from tcrm.addons.bus.models.bus import json_dump
from tcrm.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from tcrm.tests import HttpCase, tagged, users
