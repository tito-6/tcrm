...
seamless communication in Tcrm Discuss without any constraints.

> Please note that this extension only works for Tcrm 17 and higher and is not
...
- Command scope must be set to `global`. You can click the extension icon to get
  ...
  directly.
- Push-to-Talk should be enabled on Tcrm Discuss voice settings.
