...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the Tcrm environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Tcrm can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'TCRM' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Tcrm Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': tcrm_version,
            'softwareDevName': 'Tcrm SA',
            'softwareDevContact': 'andu@tcrm.com',
