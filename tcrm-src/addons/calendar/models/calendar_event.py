...
from tcrm.addons.base.models.res_partner import _tz_get
from tcrm.addons.calendar.models.calendar_attendee import CalendarAttendee
from tcrm.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from tcrm.addons.calendar.models.utils import interval_from_events
from tcrm.tools.intervals import intervals_overlap
from tcrm.tools.translate import _
from tcrm.tools.misc import get_lang
from tcrm.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
...
class CalendarEvent(models.Model):
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Tcrm'
    ...
    def _get_contact_details_description(self, organizer, partners):
        ...
        """
        tcrmbot = self.env.ref('base.user_root')
        contact_description = []
        # Organizer
        if organizer and organizer != tcrmbot:
        ...
        first_partner = partners.filtered(lambda partner: partner not in (tcrmbot.partner_id + organizer.partner_id))[:1]
        if first_partner:
