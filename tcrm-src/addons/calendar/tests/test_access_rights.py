...
from tcrm.tests.common import TransactionCase, new_test_user
...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('tcrm.tests', 'tcrm.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_tcrm(self):
        # set notifications to "handle in Tcrm" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Tcrm" notification setting can
