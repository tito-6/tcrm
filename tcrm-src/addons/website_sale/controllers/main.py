...
from tcrm.tools import SQL, clean_context, float_round, groupby, lazy, str2bool
from tcrm.tools.json import scriptsafe as json_scriptsafe
from tcrm.tools.translate import LazyTranslate, _

from tcrm.addons.payment import utils as payment_utils
from tcrm.addons.payment.controllers import portal as payment_portal
from tcrm.addons.sale.controllers import portal as sale_portal
from tcrm.addons.html_editor.tools import get_video_thumbnail
from tcrm.addons.website.controllers.main import QueryURL
from tcrm.addons.website.models.ir_http import sitemap_qs2dom
from tcrm.addons.website_sale.const import SHOP_PATH
from tcrm.addons.website_sale.models.website import (
...
def handle_product_params_error(exc, product, category=None, **kwargs):
    ...
    :param tcrm.exceptions.AccessError | tcrm.exceptions.MissingError exc: The exception thrown
...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def add_product_media(self, media, type, product_product_id, product_template_id, combination_ids=None):
        ...
        if type == 'image':  # Image case
            ...
            media_create_data = [Command.create({
                'name': video_data.get('name', 'Tcrm Video'),
