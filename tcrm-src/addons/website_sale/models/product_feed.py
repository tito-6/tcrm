...
from tcrm import SUPERUSER_ID, api, fields, models
from tcrm.exceptions import ValidationError
from tcrm.fields import Domain
from tcrm.http import request
from tcrm.tools import float_is_zero, float_round, urls

from tcrm.addons.website_sale import const, utils
...
class ProductFeed(models.Model):
    ...
    def _prepare_gmc_price_info(self, product):
        ...
        # differently than Tcrm.
        # Ex: product="Pack of wine (6 bottles)", price=$65.00, uom_name="Pack".
        #   - in tcrm: base_unit_count=6.0, base_unit_name="750ml"
    ...
    def _notify_website_manager(self, **kwargs):
        """Send a notification to the website manager using tcrmBot.
