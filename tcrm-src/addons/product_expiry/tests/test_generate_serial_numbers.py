...
from tcrm.addons.stock.tests.test_generate_serial_numbers import StockGenerateCommon
from tcrm.addons.stock.tests.test_picking_tours import TestStockPickingTour
