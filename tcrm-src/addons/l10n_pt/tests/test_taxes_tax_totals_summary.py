...
from tcrm.addons.account.tests.test_taxes_tax_totals_summary import TestTaxesTaxTotalsSummary
...
class TestTaxesTaxTotalsSummaryL10nPt(TestTaxesTaxTotalsSummary):
    ...
    def _test_taxes_l10n_pt(self):
        """ !!!! THOSE TESTS ARE THERE TO CERTIFY THE USE OF TCRM INVOICING IN PORTUGAL.
