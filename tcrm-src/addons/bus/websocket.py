...
import tcrm
from tcrm import api, modules
from .models.bus import dispatch
from tcrm.http import root, Request, Response, SessionExpiredException, get_default_session
from tcrm.modules.registry import Registry
from tcrm.service import model as service_model
from tcrm.service.server import CommonServer
from tcrm.service.security import check_session
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if tcrm.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('tcrm_BUS_PUBLIC_SAMESITE_WS'):
            return
