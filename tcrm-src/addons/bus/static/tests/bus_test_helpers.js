import { after, expect, registerDebugInfo } from "@tcrm/hoot";
import { Deferred } from "@tcrm/hoot-mock";
import {
    MockServer,
    asyncStep,
    defineModels,
...
import { on, runAllTimers, waitUntil } from "@tcrm/hoot-dom";
...
/** @type {Record<string, (env: tcrmEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<tcrmEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: tcrmEnv, id: string, payload: any) => any} handler
 */
