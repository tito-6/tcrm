...
import tcrm
import tcrm.tools
from tcrm.exceptions import AccessDenied, AccessError
from tcrm.http import _request_stack
from tcrm.service import common as auth
from tcrm.service import model
from tcrm.tests import common
from tcrm.tools import DotDict, mute_logger

from tcrm.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestXMLRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        ml_xml = mute_logger('tcrm.addons.rpc.controllers.xmlrpc')
        ml_xml.__enter__()  # noqa: PLC2801
        self.addCleanup(ml_xml.__exit__)

        ml_json = mute_logger('tcrm.addons.rpc.controllers.jsonrpc')
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   tcrm.api.model(lambda *_: collections.defaultdict(int)))
