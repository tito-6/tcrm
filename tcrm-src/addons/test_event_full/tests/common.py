...
from tcrm.addons.base.tests.common import HttpCaseWithUserDemo, HttpCaseWithUserPortal
from tcrm.addons.base.tests.test_ir_cron import CronMixinCase
from tcrm.addons.event.tests.common import EventCase
from tcrm.addons.event_crm.tests.common import EventCrmCase
from tcrm.addons.mail.tests.common import mail_new_test_user, MailCase
from tcrm.addons.sales_team.tests.common import TestSalesCommon
from tcrm.addons.sms.tests.common import SMSCase
from tcrm.addons.website.tests.test_website_visitor import MockVisitor
