...
from tcrm import api, Command, fields, models, _
...
from tcrm.tools import email_normalize, email_normalize_all, groupby, urls
from tcrm.tools.misc import hash_sign
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(
        ...
        required=True,
        selection=[
            ('tcrm', "Full Reference (INV/2024/00001)"),
            ('euro', "European (RF83INV202400001)"),
            ('number', "Numbers only (202400001)"),
        ],
        default=_default_invoice_reference_model,
        help="You can choose different models for each type of reference. The default one is the Tcrm reference.",
    )
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Tcrm.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Tcrm.\n"
        "Check: Pay bills by check and print it from tcrm.\n"
    ...
    alias_name = fields.Char(help="Send one separate email for each invoice.\n"
                                  ...
                                  "Only PDF and XML files will be interpreted by Tcrm")
