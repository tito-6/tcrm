...
from tcrm import models, api, _, fields, tools
from tcrm.exceptions import UserError
from tcrm.fields import Command, Domain
from tcrm.release import version
from tcrm.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from tcrm.tools.misc import formatLang, format_date as tcrm_format_date, get_lang
...
class AccountJournal(models.Model):
    ...
    def _transform_activity_dict(self, activity_data):
        return {
            ...
            'date': tcrm_format_date(self.env, activity_data['date_deadline']),
        }
