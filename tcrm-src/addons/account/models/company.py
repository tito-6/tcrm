...
from tcrm import fields, models, api, _, Command
from tcrm.exceptions import LockError, ValidationError, UserError, RedirectWarning
from tcrm.tools import date_utils, format_list, SQL
from tcrm.tools.mail import is_html_empty
from tcrm.tools.misc import format_date
from tcrm.addons.account.models.account_move import MAX_HASH_VERSION
from tcrm.addons.account.models.product import ACCOUNT_DOMAIN
from tcrm.addons.account.models.partner import _ref_company_registry
from tcrm.addons.base_vat.models.res_partner import _ref_vat
...
class ResCompany(models.Model):
    ...
    account_purchase_receipt_fiscal_position_id = fields.Many2one('account.fiscal.position', string="Default Purchase Receipt Fiscal Position", check_company=True)
