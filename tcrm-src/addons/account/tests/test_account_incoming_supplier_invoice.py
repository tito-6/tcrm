...
from tcrm.tests import tagged, RecordCapturer
...
from tcrm.addons.test_mimetypes.tests.test_guess_mimetypes import contents
...
class TestAccountInvoiceImportMixin:
    ...
    def assert_attachment_import(self, origin, attachments_vals, expected_invoices):
        """ Simulate the upload and import of one or more attachments and assert that the
            ...
            :param attachments_vals: A list of values representing the attachments to be uploaded to Tcrm
    ...
    def _upload_and_import_attachments(self, origin, attachments_vals):
        """ Simulate the upload of one or more attachments and their processing by the import framework.
            ...
            :param origin: The source from which the attachments should be introduced into Tcrm.
                           Possible values:
            ...
            :param attachments_vals: A list of values representing attachments to upload into Tcrm.
...
class TestAccountIncomingSupplierInvoice(AccountTestInvoicingCommon, TestAccountInvoiceImportMixin, MailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.internal_user = cls._create_new_internal_user(login='internal.user@test.tcrm.com')
