...
from tcrm.tools import make_index_name, SQL
from tcrm.tools.translate import TranslationImporter
from tcrm.tests import standalone
from tcrm.addons.account.models.chart_template import AccountChartTemplate
...
def test_all_l10n(env):
    ...
    logger = logging.getLogger('tcrm.loading')
