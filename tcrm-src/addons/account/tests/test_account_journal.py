...
from tcrm.tools import hash_sign
...
from tcrm.tests import Form, tagged, HttpCase, new_test_user
from tcrm.addons.test_mail.data.test_mail_data import MAIL_EML_ATTACHMENT
...
class TestAccountJournalAlias(AccountTestInvoicingCommon, MailCommon):
    ...
    def test_alias_name_creation(self):
        ...
        characters removal. See tcrm/tcrm@339cdffb68f91eb1455d447d1bdd7133c68723bd """
    ...
    def test_alias_from_type(self):
        ...
        well as defaults update, see tcrm/tcrm@400b6860271a11b9914166ff7e42939c4c6192dc """
        journal = self.company_data['default_journal_purchase']
