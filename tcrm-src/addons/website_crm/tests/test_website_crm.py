...
class TestWebsiteCrm(tcrm.tests.HttpCase, TestCrmCommon):
    ...
    def test_tour(self):
        ...
        self.assertEqual(record.partner_name, 'Tcrm S.A.')
    ...
    def test_catch_logged_partner_info_tour(self):
        ...
        with tcrm.tests.RecordCapturer(self.env['crm.lead']) as capt:
