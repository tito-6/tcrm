...
from tcrm.http import JsonRPCDispatcher, serialize_exception
...
if not IS_TEST:
    # Test IoT system is expected to handle Tcrm database unlike "real" IoT systems.

    def db_list(force=False, host=None):
        return []

    tcrm.http.db_list = db_list
