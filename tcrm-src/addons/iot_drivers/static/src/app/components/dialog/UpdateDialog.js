...
export class UpdateDialog extends Component {
    ...
    async getVersionInfo() {
        try {
            ...
            this.state.tcrmIsUpToDate = data.tcrmIsUpToDate;
    ...
    get everythingIsUpToDate() {
        return this.state.tcrmIsUpToDate && this.state.imageIsUpToDate;
    }
    ...
    <t t-translation="off">
        ...
        <BootstrapDialog identifier="'update-configuration'" btnName="'Update'" onOpen.bind="getVersionInfo" onClose.bind="onClose">
            <t t-set-slot="header">
                <div>
                    Update
                    <a href="https://www.tcrm.com/documentation/latest/applications/general/iot/iot_advanced/updating_iot.html" class="fa fa-question-circle text-decoration-none text-dark" target="_blank"></a>
                </div>
            </t>
            <t t-set-slot="body">
                ...
                <div class="mb-3" t-if="this.store.isLinux">
                    ...
                    <div t-else="" class="alert alert-warning small mb-0">
                        ...
                        <a href="https://www.tcrm.com/documentation/latest/applications/general/iot/iot_advanced/updating_iot.html#iot-updating-iot-image-code" target="_blank" class="alert-link">
                            Flashing the SD Card on IoT Box
                        </a>
                    </div>
                    <div t-if="this.store.dev" class="alert alert-light small">
                        <a href="https://nightly.tcrm.com/master/iotbox/" target="_blank" class="alert-link">
                ...
                <div class="mb-3">
                    ...
                    <div t-if="this.state.tcrmIsUpToDate" class="text-success px-2 small">
                    ...
                    <div t-if="this.store.dev" class="alert alert-light small">
                        Current: 
                        <a t-att-href="'https://github.com/tcrm/tcrm/commit/' + this.state.currentCommitHash" target="_blank" class="alert-link">
