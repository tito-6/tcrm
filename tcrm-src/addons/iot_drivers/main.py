...
from tcrm.addons.iot_drivers.tools import certificate, helpers, upgrade, wifi
from tcrm.addons.iot_drivers.tools.system import IS_RPI
from tcrm.addons.iot_drivers.websocket_client import WebsocketClient
...
class Manager(Thread):
    ...
    def _send_all_devices(self, server_url=None):
        """This method send IoT Box and devices information to Tcrm database
    ...
    def run(self):
        """Thread that will load interfaces and drivers and contact the tcrm server
        ...
        if IS_RPI and helpers.get_tcrm_server_url():
