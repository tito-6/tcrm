...
from tcrm import api, fields, Command, models, _
from tcrm.exceptions import RedirectWarning, UserError, ValidationError
from tcrm.tools import clean_context, email_normalize, float_repr, float_round, format_date, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default tcrm rate when the following change:
    ...
    def _get_base_account(self):
        ...
        if not account:
            raise UserError(self.env._(
                "Tcrm had a look at your expense, its product, your company and the journal but came back with empty hands.\n"
                "Give Tcrm a hand to find an account by setting up an expense account.\n"
