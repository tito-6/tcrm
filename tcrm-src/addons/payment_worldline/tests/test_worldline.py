...
from tcrm.addons.payment_worldline.tests.common import WorldlineCommon


@tagged('post_install', '-at_install')
class WorldlineTest(WorldlineCommon, PaymentHttpCommon):

    @mute_logger('tcrm.addons.payment_worldline.controllers.main')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'tcrm.addons.payment_worldline.controllers.main.WorldlineController._verify_signature'
        ):
