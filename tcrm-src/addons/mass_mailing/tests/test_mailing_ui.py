...
class TestMailingUi(MassMailCommon, HttpCaseWithUserDemo):
    ...
    def test_mailing_campaign_tour(self):
        ...
        self.start_tour("/tcrm", 'mailing_campaign', login="user_marketing")
    ...
    def test_mailing_editor_tour(self):
        ...
        self.start_tour("/tcrm", 'mailing_editor', login="user_marketing")
    ...
    def test_mailing_editor_theme_tour(self):
        self.start_tour('/tcrm', 'mailing_editor_theme', login="demo")

    def test_snippets_mailing_menu_tabs_tour(self):
        self.start_tour("/tcrm", 'snippets_mailing_menu_tabs', login="demo")

    def test_snippets_mailing_menu_toolbar_tour(self):
        self.start_tour("/tcrm", 'snippets_mailing_menu_toolbar', login="demo")

    def test_snippets_mailing_menu_toolbar_mobile_tour(self):
        self.start_tour("/tcrm", 'snippets_mailing_menu_toolbar_mobile', login="demo")

    def test_mass_mailing_code_view_tour(self):
        self.start_tour("/tcrm?debug=tests", 'mass_mailing_code_view_tour', login="demo")

    def test_mass_mailing_dynamic_placeholder_tour(self):
        self.start_tour("/tcrm", 'mass_mailing_dynamic_placeholder_tour', login="demo")
