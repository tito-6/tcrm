...
from tcrm.addons.account_peppol.exceptions import get_ebms_message, get_exception_message
from tcrm.addons.account_peppol.tools.demo_utils import handle_demo
...
class Account_Edi_Proxy_ClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['peppol'] = {
            'prod': 'https://peppol.api.tcrm.com',
            'test': 'https://peppol.test.tcrm.com',
            'demo': 'demo',
        }
        return urls
    ...
    def _peppol_register_sender_as_receiver(self):
        ...
        # but we need the field for future in case the user decided to migrate away from tcrm
