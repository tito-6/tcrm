...
from tcrm.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@tcrm.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(tcrm.tests.HttpCase):
    def test_tour(self):
        ...
        with tcrm.tests.RecordCapturer(self.env['hr.applicant']) as capt:
