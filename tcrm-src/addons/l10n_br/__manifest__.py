# Part of Tcrm. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.1',
    'website': 'https://www.tcrm.com/documentation/latest/applications/finance/fiscal_localizations/brazil.html',
...
configure Tcrm in order to properly use Avatax and send the needed fiscal
