...
- `17.0`
  - The support for express checkout is added. tcrm/tcrm#113644
  - The support for customer fees is removed as it is no longer supported by the `payment` module.
    tcrm/tcrm#132104
- `16.3`
  - The support for partial manual capture is added. tcrm/tcrm#117356
- `16.0`
  - The module is renamed from `payment_test` to `payment_demo`. tcrm/tcrm#99397
  - The support for manual capture, full and partial refunds, customer fees, and the selection of
    the payment outcome are added. tcrm/tcrm#78083
