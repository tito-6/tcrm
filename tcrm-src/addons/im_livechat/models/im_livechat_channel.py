...
from tcrm.addons.bus.websocket import WebsocketConnectionHandler
...
class Im_LivechatChannel(models.Model):
    """ Livechat Channel
        ...
        external website), 'script_internal' (code to be integrated with tcrm website) or via 'web_page' link.
