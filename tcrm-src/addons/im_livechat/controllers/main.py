...
from tcrm.http import content_disposition, request
from tcrm.addons.base.models.ir_qweb_fields import nl2br
from tcrm.addons.mail.tools.discuss import add_guest_to_context, Store
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/tcrm_ui_icons', type='http', auth='none', cors="*")
    def tcrm_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/tcrm_ui_icons/fonts/tcrm_ui_icons.woff2').get_response()
