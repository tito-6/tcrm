...
from tcrm.tests import new_test_user, tagged
...
from tcrm.addons.im_livechat.tests.test_get_operator import TestGetOperator
from tcrm.fields import Command, Datetime
...
class TestImLivechatChannel(TestImLivechatCommon, TestGetOperator):
    ...
    def test_review_link(self):
        ...
        self.livechat_channel.review_link = "https://www.tcrm.com"
        self.assertEqual(self.livechat_channel.review_link, "https://www.tcrm.com")
