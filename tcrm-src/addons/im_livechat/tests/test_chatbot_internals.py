...
from tcrm.addons.im_livechat.tests import chatbot_common
from tcrm.tests.common import JsonRpcException, new_test_user, tagged
from tcrm.tools.misc import mute_logger
from tcrm.addons.mail.tests.common import freeze_all_time, MailCommon
...
class ChatbotCase(MailCommon, chatbot_common.ChatbotCase):
    ...
    def test_chatbot_steps(self):
        ...
        with self.assertRaises(JsonRpcException, msg='tcrm.exceptions.ValidationError'), mute_logger("tcrm.http"):
    ...
    def test_forward_to_specific_operator(self):
        ...
        self.assertEqual(discuss_channel.name, "tcrmBot Ernest Employee")
    ...
    def test_chatbot_clear_answers_on_step_type_change(self):
        ...
        self.start_tour(f"/tcrm/action-{action.id}", 'change_chatbot_step_type', login='admin')
