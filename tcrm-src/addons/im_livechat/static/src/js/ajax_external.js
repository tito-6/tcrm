...
/**
 * This file should be used in the context of an external widget loading (e.g: live chat in a non-Tcrm website)
 ...
 * As we're not in an Tcrm website context, the calls will not work, and we avoid a 404 request.
 */
