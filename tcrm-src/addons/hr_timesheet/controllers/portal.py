...
from tcrm import fields, http, _
from tcrm.fields import Domain
from tcrm.http import request
from tcrm.tools import date_utils, groupby as groupbyelem

from tcrm.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager
