...
from tcrm import SUPERUSER_ID, _, fields, http
from tcrm.exceptions import AccessError, MissingError, ValidationError
...
class CustomerPortal(payment_portal.PaymentPortal):
    ...
    def portal_order_page(
        ...
        **kw
        ...
        backend_url = f'/tcrm/action-{order_sudo._get_portal_return_action().id}/{order_sudo.id}'
        values = {
