...
class GoogleCalendarService():
    ...
    def delete(self, event_id, token=None, timeout=TIMEOUT):
        ...
        # making the deletion be handled entirely on their side, and then we archive the events in Tcrm.
    ...
    def _google_authentication_url(self, from_url='http://www.tcrm.com'):
        state = {
