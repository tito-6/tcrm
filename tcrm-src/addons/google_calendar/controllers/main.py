...
from tcrm.addons.calendar.controllers.main import CalendarController
from tcrm.addons.google_account.models.google_service import _get_client_secret
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Tcrm
            ...
            The dictionary may contains an url, to allow Tcrm Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Tcrm to access his calendar !
