...
import { animationFrame, tick, waitFor, waitUntil } from "@tcrm/hoot-dom";
import { Deferred } from "@tcrm/hoot-mock";
import { MainComponentsContainer } from "@web/core/main_components_container";
import { patch } from "@web/core/utils/patch";
import { onMounted } from "@tcrm/owl";
import { expect } from "@tcrm/hoot";

const { DateTime } = luxon;

export const setupPosEnv = async () => {
    // Do not change these variables, they are in accordance with the demo data
    tcrm.pos_session_id = 1;
    tcrm.pos_config_id = 1;
    tcrm.from_backend = 0;
    tcrm.access_token = uuidv4(); // Avoid indexedDB conflicts
    tcrm.info = {
