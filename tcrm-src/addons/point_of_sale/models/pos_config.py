...
from tcrm import api, fields, models, _, Command, tools, SUPERUSER_ID
from tcrm.http import request
from tcrm.exceptions import AccessError, ValidationError, UserError
from tcrm.tools import SQL, convert
from tcrm.service.common import exp_version
from tcrm.addons.point_of_sale.models.pos_printer import format_epson_certified_domain
