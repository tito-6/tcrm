    ...
    */
    ...
    _call_viva_com(data, action, paymentLine) {
        return this.env.services.orm.silent
            ...
            .catch(this._handletcrmConnectionFailure.bind(this, paymentLine));
    }

    _handletcrmConnectionFailure(paymentLine, data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the Tcrm server, please check your internet connection and try again."
            )
        );
    ...
    handleVivaComStatusResponse(paymentLine, notification) {
        if (!notification) {
            this._handletcrmConnectionFailure(paymentLine);
            return;
        }
