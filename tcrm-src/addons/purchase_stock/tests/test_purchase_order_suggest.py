...
from tcrm.addons.purchase_stock.tests.common import PurchaseTestCommon
from tcrm.tests import tagged, freeze_time
...
class TestPurchaseOrderSuggest(PurchaseTestCommon, HttpCase):
    ...
    def test_purchase_order_suggest_search_panel_ux(self):
        ...
        self.start_tour('/tcrm/purchase', "test_purchase_order_suggest_search_panel_ux", login='admin')
