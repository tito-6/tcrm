...
- `17.0`
  - The previous Hosted Checkout API that allowed for redirect payments is replaced by the Recurring
    Payments API that supports direct payments and tokenization. tcrm/tcrm#143525
  - OAuth support is added in addition to the credentials-based authentication. tcrm/tcrm#158578
- `16.0`
  - The first version of the module is merged. tcrm/tcrm#92848
