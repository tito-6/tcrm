...
from tcrm.tests import Form, TransactionCase, tagged
...
class TestVariants(ProductVariantsCommon):
    ...
    def test_variants_pricelist_code(self):
        vendor = self.env['res.partner'].create({'name': 'Bidou', 'email': 'bidou@tcrm.com'})
...
class TestVariantsExclusion(ProductVariantsCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'tcrm.addons.product.models.product_product.ProductProduct._filter_to_unlink',
