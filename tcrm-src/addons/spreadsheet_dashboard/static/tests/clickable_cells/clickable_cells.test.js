...
import { click, queryAll, queryFirst } from "@tcrm/hoot-dom";
...
test("list sorting clickable cell", async () => {
    ...
    const data = {
        sheets: [
            {
                cells: {
                    A1: '=TCRM.LIST.HEADER(1, "foo")',
                    A2: '=TCRM.LIST(1, 1, "foo")',
                },
            },
        ],
        lists: {
        ...
        sheets: [
            {
                cells: {
                    ...
                    B1: "bar",
                    // spill cells
                    A2: "=TCRM.LIST.HEADER(1, A1:B1)",
                    A3: '=TCRM.LIST(1, sequence(2), "foo")',
                },
            },
        ],
        lists: {
