...
from tcrm.tests import Form, common
from tcrm.tools import float_compare, mute_logger

from tcrm.addons.sale.tests.common import TestSaleCommon
from tcrm.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import (
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('tcrm.tests.common.onchange')
