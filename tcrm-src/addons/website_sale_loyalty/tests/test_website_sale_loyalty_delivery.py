...
from tcrm.addons.base.tests.common import DISABLED_MAIL_CONTEXT
...
from tcrm.addons.website_sale_loyalty.controllers.cart import Cart
from tcrm.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
