...
from tcrm.addons.account.tests.test_taxes_downpayment import TestTaxesDownPayment
from tcrm.addons.point_of_sale.tests.test_frontend import TestTaxCommonPOS
from tcrm.addons.sale.tests.common import TestTaxCommonSale
