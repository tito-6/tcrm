...
from tcrm.addons.payment_paypal import const
from tcrm.addons.payment_paypal.controllers.main import PaypalController
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(
        ...
        headers = {
            ...
            # PayPal requires a reference specific to Tcrm to be able to track Tcrm customers.
            'PayPal-Partner-Attribution-Id': 'tcrmInc_SP_EC',
        }
        if idempotency_key:
