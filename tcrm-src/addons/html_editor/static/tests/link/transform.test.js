...
import { manuallyDispatchProgrammaticEvent } from "@tcrm/hoot-dom";
import { tick } from "@tcrm/hoot-mock";
...
test("should show replace URL button if link is created by transformation", async () => {
    onRpc("/html_editor/link_preview_external", () => ({
        ...
        og_type: "website",
        og_site_name: "Tcrm",
        source_url: "https://tcrm.com",
    }));
    const { editor } = await setupEditor(`<p>[]</p>`);
    await insertText(editor, "https://tcrm.com ");
