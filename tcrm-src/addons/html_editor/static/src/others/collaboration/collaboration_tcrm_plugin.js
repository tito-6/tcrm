...
/**
 * @typedef { Object } CollaborationtcrmShared
 * @property { CollaborationtcrmPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationtcrmPlugin extends Plugin {
    static id = "collaborationtcrm";
        ...
        return new PeerToPeer({
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    case "ptp_remove":
                        // todo: to implement
                        // this.tcrmEditor.multiselectionRemove(notificationPayload);
                        break;
                    case "ptp_disconnect":
                        this.ptp.removePeer(fromPeerId);
                        // todo: to implement
                        // this.tcrmEditor.multiselectionRemove(fromPeerId);
                        break;
    ...
    async resetFromServerAndResyncWithPeers() {
        ...
        // lastHistoryId will be different if the tcrm bus did not have time to
        // notify the user.
    ...
    showConflictDialog() {
        ...
        //     return;
        // }
        // const content = markup(this.tcrmEditor.editable.cloneNode(true).outerHTML);
