...
export class CollaborationSelectionPlugin extends Plugin {
    ...
    static dependencies = ["history", "collaborationtcrm", "position", "localOverlay"];
    ...
    /**
     * @param {import("./collaboration_tcrm_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerSelection({ selection, peerId }) {
        const peerMetadata = this.dependencies.collaborationtcrm.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
