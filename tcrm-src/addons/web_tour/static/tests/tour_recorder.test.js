...
import { click, edit, keyDown, keyUp, press, queryOne } from "@tcrm/hoot-dom";
...
test("Click on element with unique tcrm class", async () => {
...
test("Click on element with no unique tcrm class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest tcrm class", async () => {
