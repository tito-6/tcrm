...
from tcrm.addons.l10n_tr_nilvera.const import NILVERA_ERROR_CODE_MESSAGES
from tcrm.addons.l10n_tr_nilvera.lib.nilvera_client import _get_nilvera_client
...
class AccountMove(models.Model):
    ...
    def _cron_nilvera_get_sale_pdf(self, batch_size=100):
        """ Fetches the Nilvera generated PDFs for the sales generated on Tcrm. """
