...
from tcrm import api, fields, models, _, tools
from tcrm.fields import Domain
from tcrm.exceptions import ValidationError, AccessError, RedirectWarning, UserError
from tcrm.tools import convert, format_time, email_normalize, SQL, Query
from tcrm.tools.intervals import Intervals
from tcrm.addons.hr.models.hr_version import format_date_abbr
from tcrm.addons.mail.tools.discuss import Store
from tcrm.tools.float_utils import float_is_zero
...
class HrEmployee(models.Model):
    ...
    def _check_access(self, operation):
        ...
        # Since Tcrm 19, one must have read access to the comodel to modify the
        # relation.
...
We can redirect you to the public employee list."""
    ...
    def create(self, vals_list):
        ...
        for employee in employees:
            ...
            url = '/tcrm/%s/action-hr.plan_wizard_action?active_model=hr.employee&menu_id=%s' % (employee.id, hr_root_menu.id)
