...
from tcrm.addons.website_sale.tests.common import MockRequest
from tcrm.addons.website_sale_collect.tests.common import ClickAndCollectCommon
from tcrm.addons.website_sale_stock.tests.common import WebsiteSaleStockCommon
...
class TestDeliveryCarrier(ClickAndCollectCommon, WebsiteSaleStockCommon):
    ...
    def test_in_store_get_close_locations_returned_data(self):
        ...
        with patch(
            'tcrm.addons.base_geolocalize.models.res_partner.ResPartner.geo_localize',
            return_value=True
