...
from tcrm.tools import consteq, email_normalize
from tcrm.addons.google_gmail.models.google_gmail_mixin import GMAIL_TOKEN_REQUEST_TIMEOUT
...
class GoogleGmailController(http.Controller):
    ...
    def _get_redirect_url(self, record):
        ...
        if (
            ...
            return f'/tcrm/{record._name}/{record.id}'
        return f'/tcrm/my-preferences/{request.env.user.id}'
