...
from tcrm.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from tcrm.tests.common import JsonRpcException
...
class TestSmsController(TestSMSActionsCommon):
    ...
    @mute_logger("tcrm.addons.base.models.ir_http")
    ...
    @mute_logger('tcrm.addons.base.models.ir_http', 'tcrm.addons.sms.controllers.main', 'tcrm.http')
