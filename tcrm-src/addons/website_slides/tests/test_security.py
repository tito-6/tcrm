...
from tcrm.addons.base.tests.test_mimetypes import PNG
from tcrm.addons.mail.tests.common import mail_new_test_user
from tcrm.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('Tcrm.models', 'Tcrm.addons.base.models.ir_rule')
...
class TestAccessHttp(common.SlidesCase, HttpCase):
    @mute_logger('Tcrm.models', 'Tcrm.addons.base.models.ir_rule', 'Tcrm.http')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('Tcrm.models.unlink', 'Tcrm.addons.base.models.ir_rule', 'Tcrm.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("Tcrm.exceptions.ValidationError", res2.text)
