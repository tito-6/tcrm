...
from tcrm import http, tests
from tcrm.addons.base.tests.common import HttpCaseWithUserPortal
from tcrm.addons.gamification.tests.common import HttpCaseGamification
...
class TestUi(TestUICommon):
    ...
    @mute_logger("Tcrm.http", "Tcrm.addons.base.models.ir_rule", "werkzeug")
...
class TestUiPublisher(HttpCaseGamification):
    ...
    def fetch_proxy(self, url):
        if url.endswith('ThreeTimeAKCGoldWinnerPembrookeWelshCorgi.jpg'):
            ...
            with file_open('base/tests/Tcrm.jpg', 'rb') as f:
                content = f.read()
