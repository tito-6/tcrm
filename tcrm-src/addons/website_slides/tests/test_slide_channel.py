...
from tcrm.addons.website_slides.tests import common as slides_common
from tcrm.exceptions import UserError
from tcrm.tests.common import HttpCase, users
...
class TestSlidesManagement(slides_common.SlidesCase, HttpCase):
    ...
    def test_default_completion_time(self):
        ...
        with patch(
            'Tcrm.addons.website_slides.models.slide_slide.SlideSlide._get_completion_time_pdf',
