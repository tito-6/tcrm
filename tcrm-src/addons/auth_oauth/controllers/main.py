...
from tcrm import api, http, SUPERUSER_ID, _
...
from tcrm.addons.auth_signup.controllers.main import AuthSignupHome as Home
from tcrm.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/tcrm/action-%s' % action
            elif menu:
                url = '/tcrm?menu_id=%s' % menu
    ...
    def oea(self, **kw):
        """login user via Tcrm Account provider"""
