...
from tcrm.addons.pos_restaurant.tests.test_frontend import TestFrontendCommon
from tcrm.addons.pos_self_order.tests.self_order_common_test import SelfOrderCommonTest
from unittest.mock import patch
from tcrm.addons.http_routing.models import ir_http
from tcrm.addons.pos_online_payment.controllers.payment_portal import PaymentPortal
