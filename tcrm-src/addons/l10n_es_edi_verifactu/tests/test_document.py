...
from tcrm import _, Command
from tcrm.exceptions import UserError, RedirectWarning, AccessError
from tcrm.tests import tagged
from tcrm.tools import zeep
...
class TestL10nEsEdiVerifactuDocument(TestL10nEsEdiVerifactuCommon):
    ...
    def test_generation_error(self):
        check_function_path = 'tcrm.addons.l10n_es_edi_verifactu.models.verifactu_document.L10nEsEdiVerifactuDocument._check_record_values'
