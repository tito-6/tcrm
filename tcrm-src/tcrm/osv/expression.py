...
tcrm will use the SQL function 'unaccent' when available for the
...
import tcrm.orm.domains as orm_domains
import tcrm.modules
from tcrm.tools import Query, SQL
...
def normalize_domain(domain):
    ...
    """
    warnings.warn("Since 19.0, use tcrm.fields.Domain", DeprecationWarning)
...
def get_unaccent_wrapper(cr):
    ...
    return tcrm.modules.registry.Registry(cr.dbname).unaccent
