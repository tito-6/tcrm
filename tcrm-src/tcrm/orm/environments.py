...
"""The tcrm API module defines tcrm Environments.
"""
...
from tcrm.exceptions import AccessError, UserError, CacheMiss
from tcrm.sql_db import BaseCursor
from tcrm.tools import clean_context, frozendict, reset_cached_properties, OrderedSet, Query, SQL
from tcrm.tools.translate import get_translation, get_translated_module, LazyGettext
from tcrm.tools.misc import StackMap, SENTINEL
...
_logger = logging.getLogger('tcrm.api')
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~tcrm.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~tcrm.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~tcrm.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~tcrm.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in tcrm.tools.file_open_temporary_directory)
