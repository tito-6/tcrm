...
from tcrm.exceptions import AccessError, UserError, MissingError
from tcrm.tools import SQL, OrderedSet, is_list_of, html_sanitize
from tcrm.tools.misc import frozendict, has_list_types
...
class Properties(Field):
    ...
    like tcrm fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~tcrm.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~tcrm.fields.Properties`
