...
from tcrm.tools import Query, SQL, reset_cached_properties, sql
from tcrm.tools.constants import PREFETCH_MAX
from tcrm.tools.misc import SENTINEL, ReadonlyDict, Sentinel, unique
...
_logger = logging.getLogger('tcrm.fields')
...
class Field(typing.Generic[T]):
    ...
    def _get_attrs(self, model_class: type[BaseModel], name: str) -> dict[str, typing.Any]:
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since tcrm 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, stacklevel=2)
