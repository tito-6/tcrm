...
from tcrm.netsvc import COLOR_PATTERN, DEFAULT, GREEN, RED, ColoredFormatter
from tcrm.tools import SQL, html_normalize, html_sanitize, html2plaintext, is_html_empty, plaintext2html, sql
from tcrm.tools.misc import OrderedSet, SENTINEL, Sentinel
from tcrm.tools.sql import pattern_to_translated_trigram_pattern, pg_varchar, value_to_translated_trigram_pattern
from tcrm.tools.translate import html_translate
...
class Html(BaseString):
    ...
    def _get_attrs(self, model_class, name):
        ...
        # we do not need this Microsoft Outlook client feature for emails displayed tcrm's web client.
