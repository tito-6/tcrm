...
from tcrm.exceptions import AccessError, MissingError, UserError
from tcrm.tools import SQL, OrderedSet, Query, sql, unique
from tcrm.tools.constants import PREFETCH_MAX
from tcrm.tools.misc import SENTINEL, Sentinel, unquote
...
if typing.TYPE_CHECKING:
    ...
    from tcrm.tools.misc import Collector
...
class Many2one(_Relational):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~tcrm.models.Model._check_company`. Has a different behaviour
...
class Many2many(_RelationalMulti):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~tcrm.models.Model._check_company`. Add a default company
