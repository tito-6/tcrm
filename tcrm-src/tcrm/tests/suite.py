...
tcrm tests customisation combined with the need of a cross version compatibility
started to make TestSuite and other unitest object more complicated than vendoring
the part we need for tcrm. This versions is simplified in order
...
class TestSuite(BaseTestSuite):
    ...
    def run(self, result, debug=False):
        for test in self:
            ...
            tcrm.modules.module.current_test = test
