...
tcrm_TEST_MAX_FAILED_TESTS = max(1, int(os.environ.get('tcrm_TEST_MAX_FAILED_TESTS', sys.maxsize)))

stats_logger = logging.getLogger('tcrm.tests.stats')
...
class tcrmTestResult(object):
    ...
    def _checkShouldStop(self):
        if self.total_errors_count() >= tcrm_TEST_MAX_FAILED_TESTS:
            ...
            if not global_report.shouldStop:
                _logger.error(
                    ...
                    "Remaining tests will be skipped.", tcrm_TEST_MAX_FAILED_TESTS)
