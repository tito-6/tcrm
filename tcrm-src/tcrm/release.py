...
product_name = 'tcrm'
description = 'tcrm Server'
long_desc = '''TCRM is a complete ERP and CRM platform. The main features are accounting (analytic
...
author = 'TCRM'
author_email = 'info@tcrm.com'
license = 'Proprietary'

nt_service_name = "tcrm-server-" + series.replace('~','-')
