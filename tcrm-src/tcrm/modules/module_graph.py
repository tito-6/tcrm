...
from tcrm.tools import reset_cached_properties, OrderedSet
...
class ModuleNode:
    """
    Loading and upgrade info for an tcrm module
    """
...
class ModuleGraph:
    """
    Sorted tcrm modules ordered by (module.phase, module.depth, module.name)
    """
