...
from tcrm.modules.module import Manifest, MANIFEST_NAMES
from tcrm.service.db import _create_empty_database, DatabaseExists
from tcrm.tools import config


class Start(Command):
    """ Quickly start the tcrm server with default options """
