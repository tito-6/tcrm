...
from tcrm.cli.command import Command
from tcrm.fields import Domain
from tcrm.modules import get_module_path
from tcrm.modules.registry import Registry
from tcrm.tools import OrderedSet, config
from tcrm.tools.translate import TranslationImporter, load_language, trans_export
    ...
    def __init__(self, *args, **kwargs):
        ...
        for parser in (self.import_parser, self.export_parser, self.loadlang_parser):
            ...
            parser.epilog = textwrap.dedent("""\
                ...
                Examples:
                    tcrm-bin i18n loadlang -l en         # English (U.S.)
                    tcrm-bin i18n loadlang -l es es_AR   # Spanish (Spain, Argentina)
                    tcrm-bin i18n loadlang -l sr@latin   # Serbian (Latin)
            """)
