...
from tcrm.exceptions import MissingError, UserError
from tcrm.http import Stream, request
from tcrm.tools import file_open, replace_exceptions
from tcrm.tools.image import image_guess_size_from_field_name, image_process
from tcrm.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
from tcrm.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:tcrm.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~tcrm.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`tcrm.tools.image.image_process`.
