...
from tcrm.tools import _, frozendict, get_lang
from tcrm.tools.float_utils import float_compare
from tcrm.tools.misc import get_diff, unquote
from tcrm.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since tcrm 8.0 a button 'Create Menu Action' button is available on the
