...
from tcrm import api, Command, fields, models
from tcrm.tools import OrderedSet
from tcrm.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        callable taking a record-ish (a dictionary representing an tcrm
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`tcrm.models.Model.write` expects.

        :param model: :class:`tcrm.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`tcrm.fields.Field`
