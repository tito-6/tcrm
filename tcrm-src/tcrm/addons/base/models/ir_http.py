...
import tcrm
from tcrm import api, http, models, tools
from tcrm.api import SUPERUSER_ID
from tcrm.exceptions import AccessDenied
from tcrm.http import ROUTING_KEYS, SAFE_HTTP_METHODS, Response, request
from tcrm.modules.registry import Registry
from tcrm.service import security
from tcrm.tools.json import json_default
from tcrm.tools.misc import get_lang, submap
from tcrm.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and tcrm.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (tcrm.exceptions.AccessError, tcrm.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, tcrm.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(tcrm.tools.config['server_wide_modules'])
    ...
    def _gc_sessions(self):
        if os.getenv("tcrm_SKIP_GC_SESSIONS"):
            return
