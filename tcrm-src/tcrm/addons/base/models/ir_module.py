...
from tcrm.exceptions import AccessDenied, UserError, ValidationError
from tcrm.fields import Domain
from tcrm.tools import config
from tcrm.tools.parse_version import parse_version
from tcrm.tools.misc import topological_sort, get_flag
from tcrm.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
from tcrm.http import request
from tcrm.modules.module import Manifest, MissingDependency
...
class IrModuleModule(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'tcrm Enterprise Edition License v1.0'),
        ('OPL-1', 'tcrm Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('tcrm Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        if self.search_count([('state', 'in', ('to install', 'to upgrade', 'to remove'))], limit=1):
            raise UserError(_("tcrm is currently processing another module operation.\n"
        ...
        try:
            ...
            raise UserError(_("tcrm is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(tcrm.tools.config['server_wide_modules']) & set(self.mapped('name'))
