...
from tcrm.tests.common import standalone
from tcrm.tests.test_module_operations import install
from tcrm.tools import mute_logger
from tcrm.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('tcrm.modules.registry'):
