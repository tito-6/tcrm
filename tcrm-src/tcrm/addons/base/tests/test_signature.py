...
from tcrm.tools.pdf.signature import PdfSigner
...
class TestSignature(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cert_subject = x509.Name([
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "tcrm"),
            x509.NameAttribute(NameOID.COMMON_NAME, "tcrm.com")
        ])
