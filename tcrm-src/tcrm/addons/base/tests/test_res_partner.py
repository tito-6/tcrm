...
from tcrm import Command, models
from tcrm.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from tcrm.addons.base.models.res_partner import ResPartner
from tcrm.addons.base.tests.common import TransactionCaseWithUserDemo
from tcrm.exceptions import AccessError, RedirectWarning, UserError, ValidationError
from tcrm.tests import Form
from tcrm.tests.common import new_test_user, tagged, TransactionCase, users
...
class TestPartner(TransactionCaseWithUserDemo):
    ...
    def test_main_user_id(self):
        """Test main_user_id compute, including tcrmBot special case and priority among several users."""
