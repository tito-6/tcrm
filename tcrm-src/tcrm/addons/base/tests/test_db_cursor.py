...
from tcrm.tests.common import BaseCase, HttpCase
from tcrm.tests.test_cursor import TestCursor
from tcrm.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('tcrm.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:tcrm.sql_db:Found different un-closed cursor', msg)
