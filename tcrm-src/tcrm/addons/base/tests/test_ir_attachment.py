...
from tcrm.tools.image import image_to_base64
...
class TestIrAttachment(TransactionCaseWithUserDemo):
    ...
    def test_10_image_autoresize(self):
        ...
        with Image.open(os.path.join(dir_path, 'tcrm.jpg'), 'r') as logo:
...
class TestPermissions(TransactionCaseWithUserDemo):
    ...
    @mute_logger("tcrm.addons.base.models.ir_rule", "tcrm.models")
