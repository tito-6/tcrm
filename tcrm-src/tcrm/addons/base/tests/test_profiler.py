...
from tcrm.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from tcrm.tools import profiler
from tcrm.tools.profiler import Profiler, ExecutionContext
from tcrm.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('tcrm.sql_db.db_connect', return_value=self.registry))
