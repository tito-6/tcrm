...
from tcrm.tests import BaseCase, TransactionCase, tagged, BaseCase
from tcrm.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when tcrm_TEST_FAILURE_RETRIES is set"""
