...
from tcrm.addons.base.tests.common import TransactionCaseWithUserDemo
...
class TestServerActions(TestServerActionsBase):
    def test_00_server_action(self):
        with self.assertLogs('tcrm.addons.base.models.ir_actions.server_action_safe_eval',
                             level='DEBUG') as log_catcher:
            self.test_server_action.run()
            self.assertEqual(log_catcher.output, [
                'DEBUG:tcrm.addons.base.models.ir_actions.server_action_safe_eval:This is a test debug log',
                'INFO:tcrm.addons.base.models.ir_actions.server_action_safe_eval:This is a test info log',
                'WARNING:tcrm.addons.base.models.ir_actions.server_action_safe_eval:This is a test warning log',
                'ERROR:tcrm.addons.base.models.ir_actions.server_action_safe_eval:This is a test error log',
"""ERROR:tcrm.addons.base.models.ir_actions.server_action_safe_eval:This is a test exception log
...
ZeroDivisionError: division by zero""" % self.test_server_action.id
    ...
    def test_90_webhook(self):
        ...
        with patch.object(requests, 'post', _patched_post), mute_logger('tcrm.addons.base.models.ir_actions'):
            # first run: 200
            self.action.with_context(self.context).run()
...
class TestCustomFields(TestCommonCustomFields):
    def test_create_custom(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('tcrm.sql_db'):
    ...
    @mute_logger('tcrm.addons.base.models.ir_ui_view')
...
class TestCustomFieldsPostInstall(TestCommonCustomFields):
    def test_add_field_valid(self):
        ...
        with self.assertLogs('tcrm.registry') as log_catcher:
