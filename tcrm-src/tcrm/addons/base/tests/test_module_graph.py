...
class TestGraph(BaseCase):
    ...
    def _test_graph_order(
        ...
        with (
            patch('tcrm.modules.module_graph.ModuleGraph._update_from_database'),
            patch('tcrm.modules.module_graph.Manifest.for_addon', make_manifest),
            patch('tcrm.modules.module_graph.ModuleGraph._imported_modules', {'studio_customization'}),
        ):
            dummy_cr = None
