...
from tcrm.tools.mimetypes import _tcrm_guess_mimetype, guess_mimetype
...
class TestMimeGuessingtcrm(BaseCase, MimeGuessingCases):
    guess_mimetype = staticmethod(_tcrm_guess_mimetype)
...
@unittest.skipIf(guess_mimetype is _tcrm_guess_mimetype, "python-magic not installed")
