...
from tcrm.tests import Form, TransactionCase, users
from tcrm.tools import get_lang, mute_logger
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('tcrm.models.unlink', 'tcrm.fields')
    ...
    @users('test')
    @mute_logger('tcrm.addons.base.models.ir_rule', 'tcrm.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('tcrm.addons.test_orm.models.test_orm.TestOrmMultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('tcrm.addons.test_orm.models.test_orm.TestOrmDiscussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('tcrm.fields', 'tcrm.models.unlink')
