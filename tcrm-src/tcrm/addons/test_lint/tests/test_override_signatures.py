...
from tcrm.tests.common import get_db_name, tagged
...
def get_tcrm_module_name(python_module_name):
    if python_module_name.startswith('tcrm.addons.'):
        return python_module_name.split('.')[2]
    if python_module_name == 'tcrm.models':
        return 'tcrm'
    ...
    def test_lint_override_signature(self):
        ...
        for model_name, model_cls in registry.items():
            ...
            for method_name, _ in inspect.getmembers(model_cls, inspect.isroutine):
                ...
                parent_module = get_tcrm_module_name(parent_class.__module__)
                ...
                for child_class in reverse_mro:
                    ...
                    child_module = get_tcrm_module_name(child_class.__module__)
        ...
        #with open('/tmp/tcrm-override-signatures.md', 'w') as f:
