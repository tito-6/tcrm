...
class TestError(common.HttpCase):
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('tcrm.http'):
    ...
    def test_01_create(self):
        ...
        with self.assertRaises(Fault) as ctx, mute_logger("tcrm.sql_db", "tcrm.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("tcrm.sql_db"), self.assertLogs("tcrm.http", level="WARNING") as capture:
