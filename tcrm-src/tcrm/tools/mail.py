...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/tcrm/tcrm/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # tcrm, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'tcrm_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text: str, container_tag: str | None = None, with_paragraph: bool = True) -> markupsafe.Markup:
    ...
    html entities, using :func:`~tcrm.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within tcrm, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within tcrm, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@tcrm.com
    * Output: "Admin" <notifications@tcrm.com>
    """
